            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                    ...
                    child: Column(
                      children: [
                        images[selectedImageIndex].startsWith('assets/')
                            ? Image.asset(images[selectedImageIndex], height: 220)
                            : Image.network(images[selectedImageIndex], height: 220),
                            ...
                            return GestureDetector(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  border: Border.all(
                                    color: selectedImageIndex == i ? Colors.deepPurple : Colors.grey,
                                    width: 2,
                                  ),
                                ),
                                child: images[i].startsWith('assets/')
                                    ? Image.asset(images[i], height: 48, width: 48)
                                    : Image.network(images[i], height: 48, width: 48),
                              ),
                            );
                          }),
                        ),
                  ...
                  Text(widget.product.title, style: const TextStyle(fontSize: 28, fontWeight: FontWeight.bold)),
